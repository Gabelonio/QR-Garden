...
The Sources folder saves in .png files the latest images generated by the software, also contains the referenced libraries, which are property of the MVN Repository. For that reason, DO NOT REMOVE that folder. 
